...
This project is a simple RESTful API built with NestJS, following the modular architecture pattern recommended by the NestJS framework.
The API manages Books and Categories, where each book belongs to a category.

## Modular Architecture Concept

NestJS uses a module-based structure to keep the application scalable, maintainable, and well-organized.

##### Each feature has its own module that contains:

- Controller (handles HTTP requests)
- Service (contains business logic)
- Entity / Model (represents database structure)
...
- Live API : https://nest-api.rafn.tech
